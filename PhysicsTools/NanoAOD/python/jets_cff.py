...
jetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        # Additional variables for b/c-jet regression training:
...
jetTables = cms.Sequence(bjetMVA+bjetNN+cjetNN+jetTable+EnergyRingsTable+fatJetTable+subJetTable+saJetTable+saTable)
